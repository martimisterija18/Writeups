...
## Eksploatacija
- napravljena reverse shell skripta //reverse shell.py, reverse shell je način da dobiješ kontrolu nad udaljenom mašinom tako što se ta mašina sama poveže nazad ka tebi.
